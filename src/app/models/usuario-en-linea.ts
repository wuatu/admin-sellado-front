export class UsuarioEnLinea {
    ...
    constructor(id: number, id_linea: number, nombre_linea:string, id_lector:number, nombre_lector:string, ip_lector:string,
        id_usuario:number, usuario_rut: string, nombre_usuario:string, apellido_usuario:string, rfid_usuario:string, fecha_inicio:string,
        fecha_termino:string, id_calibrador:string, nombre_calibrador:string) {
