...
@Directive({
  selector: '[rutValidationAuth]',
  providers: [{ provide: NG_VALIDATORS, useExisting: RutValidationAuthDirective, multi: true }]
})
export class RutValidationAuthDirective implements Validator {
