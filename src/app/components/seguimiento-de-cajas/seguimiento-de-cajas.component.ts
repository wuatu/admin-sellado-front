      ...
      for (let h = 22; h <= 22; h++) {
        for (let m = 0; m < 10; m++) {
          ...
          for (let s = 0; s <= 60; s = s + x) {
            ...
            let date = new Date();
            let datew  = new Date("2020-12-15" + "T" + this.hora+":"+this.minuto+":"+this.segundo);
            let registroCaja = new SeguimientoDeCajas(null, 1, "Calibrador 1", b, "Línea "+b, 21458458, "Rfid 1", "192.168.0.2", 1, "Lector 1", "192.168.10.10", 1, "22222222-2", "Ignacio", "Correa", "5468254875" + count, "", "", "", "", "", "", "", "", "", "", "", "","" ,"2020-12-15", this.hora + ":" + this.minuto + ":" + this.segundo, "" ,"2020-12-15", "23:50:00",datew.getTime().toString(), 1, 1, 4);
